"""
Trains a transformer to add n-digit numbers.
"""
...
from xlm_roberta.model import GPT
from xlm_roberta.trainer import Trainer
from xlm_roberta.utils import set_seed, setup_logging, CfgNode as CN
